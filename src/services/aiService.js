...
export const AIService = {
  ...
  async matchInternships({ userSkills = [], internships = [] }) {
    try {
      ...
      return internships
        .map((i) => ({
          ...i,
          matchScore: (i.skills || []).reduce(
            (acc, s) => acc + (set.has(String(s).toLowerCase()) ? 20 : 0),
            0
          ),
          aiEnhanced: false,
        }))
  ...
  enhanceConceptMap(conceptMap) {
    ...
    conceptMap.studyTips = conceptMap.studyTips || [
        ...
        longAnswer: [
          {
            ...
            guidelines: 'Check connection and retry',
            keyPoints: ['Error'],
            difficulty: 'easy',
          },
        ],
        critical: [
          {
            ...
            approach: 'Analyze technical issues',
            considerations: ['Connection', 'Service'],
            difficulty: 'medium',
          },
        ],
        practical: [
