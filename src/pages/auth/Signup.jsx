    ...
    <div className="min-h-screen bg-gradient-to-br from-accent-50 via-white to-navy-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Create your free account and start learning</p>
        </div>
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={index} className="flex items-center text-sm text-gray-600">
                <svg
                  className="h-5 w-5 text-accent-500 mr-2 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
