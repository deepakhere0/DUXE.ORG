    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          <div
            className={`w-3 h-3 rounded-full ${dataConnect.isConfigured ? 'bg-green-500' : 'bg-red-500'}`}
          />
          <span>
            {dataConnect.isConfigured ? 'Data Connect Configured' : 'Data Connect Not Configured'}
          </span>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        ...
        {unisError && <p className="text-red-600">Error: {unisError.message}</p>}
        {universities && (
          <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        ...
        {deptsError && <p className="text-red-600">Error: {deptsError.message}</p>}
        {departments && (
          <div>
            <p className="text-green-600 mb-2">
              ✓ Successfully fetched {departments.length} departments
            </p>
            <div className="max-h-40 overflow-auto">
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-lg">
        ...
        <ol className="list-decimal list-inside space-y-1 text-sm text-blue-800">
          <li>
            Make sure you have created a <code>.env.local</code> file with your Firebase
            configuration
          </li>
          <li>
            Run <code>firebase login</code> to authenticate with Firebase
          </li>
          <li>
            Run <code>firebase init dataconnect</code> to initialize Data Connect
          </li>
          <li>
            Deploy the schema: <code>firebase deploy --only dataconnect</code>
          </li>
